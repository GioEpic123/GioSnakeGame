...
window.snapKitInit = function () {
  ...
  snap.loginkit.mountButton(loginButtonIconId, {
    clientId: '1bf09a57-4f46-45b3-ac96-1ad408dba1b4', /*YOU CHANGE: Must be changed to the development client ID on snapckit*/
    redirectURI: 'https://gio-snake-game.glitch.me/', /*YOU CHANGE: Must be changed to your glitch project's url AND added as the redirect URI on snapkit */
    scopeList: [
      'user.display_name',
      'user.bitmoji.avatar',
    ],
